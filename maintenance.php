    ...
    <div class="card-body flex-grow-1">
        <div class="col-12 h-100">
            <div class="row h-100">
                ...
                <div class="col-md-6 h-100 d-flex flex-column">
                    <div class="w-100 d-flex border-bottom border-dark py-1 mb-1">
                        <div class="fs-5 col-auto flex-grow-1"><b>Supplier List</b></div>
                        <div class="col-auto flex-grow-0 d-flex justify-content-end">
...
<script>
    $(function(){
        ...
        $('#new_supplier').click(function(){
            uni_modal('Add New Supplier',"manage_supplier.php")
        })
        $('.edit_supplier').click(function(){
            uni_modal('Edit Supplier Details',"manage_supplier.php?id="+$(this).attr('data-id'))
        })
        $('.view_supplier').click(function(){
            uni_modal('Supplier Details',"view_supplier.php?id="+$(this).attr('data-id'))
        })
        $('.delete_supplier').click(function(){
            _conf("Are you sure to delete <b>"+$(this).attr('data-name')+"</b> from Supplier List?",'delete_supplier',[$(this).attr('data-id')])
        })
    })
